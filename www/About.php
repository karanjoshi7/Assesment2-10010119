            ...
            <div class="row">
                <div class="col">
                    ...
                    <p class="text-center">
                        <br>
                        <br>
                        <br> I'm studying Diploma in computing level 6 in Toiohomai Instute of technology. Where i've got Level 3 & Level 5 Certificates from here. Here is the information of courses currently i'm enrolled in. Click My Courses to see
                        <br>
                        <br>
                    </p>
                    <nav class="nav navbar-nav hidden-md-down">
                        ...
                        <a class="dropdown-toggle nav-link" id="drop-down-5b8dc40d3f1045b8dc40d3c56812" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">
                My Courses
            </a>
                        <div class="dropdown-menu" aria-labelledby="drop-down-5b8dc40d3f1045b8dc40d3c56812">

                            <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=1339" title="COMP.6207_S2_TG_2018">COMP.6207 - Special Topic - S2 - TG - 2018</a>
                            <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=1033" title="COMP.6210_S2_TG_2018">COMP.6210 - Web Services and Design Methodologies - S2 - TG - 2018</a>
                            <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=1187" title="COMP.6212_S2_TG_2018">COMP.6212 - Data Management - S2 - TG - 2018</a>
                            <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=992" title="COMP.6213_S2_TG_2018">COMP.6213 - Project Management - S2 - TG - 2018</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <img src="img/office1.jpg" class="img-fluid">
                        <p class="text-center">
                            <br>There are few services for free in use, which helps to better undrestand the things.
                            <br>
                            <br>
                        </p>
                        <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=525" title="Study help - Studiosity">After hours Study help - Studiosity</a>
                        <a class="dropdown-item" href="https://moodle.toiohomai.ac.nz/course/view.php?id=520" title="Lynda.com">Lynda.com</a>

                    </div>
                </div>
            </div>
    </section>
    <a class="weatherwidget-io" href="https://forecast7.com/en/n37d69176d17/tauranga/" data-label_1="TAURANGA" data-label_2="WEATHER" data-theme="original">TAURANGA WEATHER</a>
    <script>
        ! function(d, s, id) {
